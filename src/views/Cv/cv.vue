<template>
  <div class="pages">
    ...
    <div class="box">
      <div style="color: blue; font-size: 15px; line-height: 35px">
        <span
          style="margin-right:20px"
          @click="goback"
        ><i class="el-icon-back" style="color: blue;" />返回</span>
        <span
          @click="downloadCv"
...
import { resumeHr, inviteFind } from '@/api/enterprise';
  ...
  methods: {
    ...
    inviteCv() {
      this.$confirm(`是否要邀请该人才`, {
        ...
        inviteFind({
          type: '101',
          cv_id: String(this.cvid),
          rcm_id: String(this.rcmid)
        }).then(rs => {
          // console.log(rs)
          this.$message({
            type: 'success',
    ...
    // downloadCv () {
    //   downCv(this.userid, this.cvid).then(rs => {
    //     // console.log(rs);
    //   });
    // },
    downloadCv() {
